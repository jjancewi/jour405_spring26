...
After examinining the distribution of the danceability scores in the Spotify dataset, I noticed that the data was slightly skewed left. This means that the data is slightly clustered to the right of the mean. The mean and distribution tells me that songs on Spotify have a strong danceability score. This is because the mean is above 0.5 at 0.67 with a standard deviation of 0.16 each way. 75% of the songs are above an 0.5 danceability, which means most songs people can dance to.
