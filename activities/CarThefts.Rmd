...
I would describe the data in the graph as 72 % normal, it is not perfectly normal, but it is somewhat close. The highest column is close to the mean, and all of the highest colums are within one standard deviation for both directions.Out of the 31 total values, 20 of them are within the range of one standard deviation from the mean. This means at 64.5% of the dat apoints are in the range.
