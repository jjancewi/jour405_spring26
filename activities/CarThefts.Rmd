...
I would describe the data in the graph as 89 % normal, it is not perfectly normal, but it is somewhat close. The highest column is close to the mean, and all of the highest columms are within one standard deviation for both directions.Out of the 31 total values, 21 of them are within the range of one standard deviation from the mean. This means at 67% of the data points are in the range.
