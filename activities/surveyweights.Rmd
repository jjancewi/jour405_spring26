...
The range of weights in this dataset is from 0.23 to 3.04.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?

When a respondent has a weight of 0.23 their response is overrepresented in the survey and they count less than one person. If their weight is 3.04 that means their response is underrepresented and their response will count for more than one person.

3. Why might some respondents be weighted more heavily than others?

Some respondents may be more heavily weighted because the demographic they are a part of is actually undercovered compared to the population demographic.
...
The category that shows the biggest difference between weighted and unweighted is rarely/never.

2. How might these differences affect reporting on likely voter turnout?

These differences affect reporting on likely voter turnout because it can lead to reporting that is factually untrue since it is hard to predict what people who rarely or never vote. If those people do vote they are not usually counted or polled, so then it is a big surprise. T
...
The differences exist because certain people are harder to reach than others. Also people will lie to pollsters on surveys, due to various reasons. The innacuracies that stem from these or other reasons may over or under represent groups in the sample. For example, in the rarely/never category the people answered that they were going to vote were over represented while the people who said no were under represented. This is because this group is eratic and hard to reach.
