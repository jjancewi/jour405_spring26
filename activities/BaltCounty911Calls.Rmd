...
The pattern I see in the data is that the daily 911 overdose trend is higher in the spring around April, then falls in the summer besides a couple of outlier. The highest is early fall, but as the year got later it generally goes down besides one outlier.
...
The difference visually is the use of call volume with the dataset of normal, unusually high, and low. The use of grey for normal, red for high, blue for low, gives the viewer the ability to see what is a normal data plot and what isn't.
```{r plot-unusual-days}
...
Compared to the normal intake of 911 overdose calls on any given day in 2022, October 4th was the most removed from the average daily 911 overdose calls in Baltimore in 2022. 
...
Some potential angles for reporting on this topic would be why do some days have such big outliers compared to the average day of 911 overdoese calls. Is there any throughline for each date? Or is it completely by chance that some days are much bigger outleris than others? What are the conditions that make this a possibility? I would then go to my editor that throughout the year there are many outliers of 911 overdose calls in each direction, and that I am trying to figure out a pattern why the outliers occur.
